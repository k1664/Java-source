...
public class ClassEx1 {
    public static void main(String[] args) {
        ...
        // 속성확인
        System.out.println(tv); // oop.Tv@24d46ca6 => Tv [size=0, color=null, channel=0, volume=0, power=false]
        System.out.println(tv2); // oop.Tv@4517d9a3
